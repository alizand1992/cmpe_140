...
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports {HILO_sel}]; # Upper Button
...
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {rst}]; # Down Button
...
set_property -dict {PACKAGE_PIN R2  IOSTANDARD LVCMOS33} [get_ports {go}]; # Switch 15

## LEDs
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {cs[0]}];  # LED 0
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports {cs[1]}];  # LED 1
#set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {cs[2]}];  # LED 2
#set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {cs[3]}];  # LED 3
...
set_property -dict {PACKAGE_PIN P3  IOSTANDARD LVCMOS33} [get_ports {go_light}]; # LED 12
set_property -dict {PACKAGE_PIN N3  IOSTANDARD LVCMOS33} [get_ports {clk}]; # LED 13
